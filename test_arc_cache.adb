...
procedure Test_ARC_Cache is
   ...
   -- String equality for generic instantiation
   ...
   package String_Cache is new ARC_Cache (Key_Type => String, Value_Type => Integer, Hash => Hash, "=" => "=");
   package Int_Cache is new ARC_Cache (Key_Type => Integer, Value_Type => String, Hash => Int_Hash, "=" => "=");
   ...
   begin
      ...
      declare
         ...
         Result : Boolean;
      begin
         String_Cache.Put (Cache, "key1", 42);
         Result := String_Cache.Get (Cache, "key1", Value);
      ...
      declare
         ...
         Result : Boolean;
      begin
         Result := String_Cache.Get (Cache, "nonexistent", Value);
      ...
      begin
         String_Cache.Put (Cache, "key1", 42);
         String_Cache.Put (Cache, "key1", 100);
         Result := String_Cache.Get (Cache, "key1", Value);
      ...
      begin
         ...
         String_Cache.Put (Cache, "key2", 2);
         String_Cache.Put (Cache, "key3", 3);
         String_Cache.Put (Cache, "key4", 4); -- This should evict key1
         ...
         Result := String_Cache.Get (Cache, "key4", Value);
      ...
      begin
         ...
         String_Cache.Get (Cache, "key1", Value);
         
         -- Add key4, should evict key2 (least recently used)
         String_Cache.Put (Cache, "key4", 4);
      ...
      declare
         ...
         Result : Boolean;
      begin
         Int_Cache.Put (Cache, 1, "one");
         Int_Cache.Put (Cache, 2, "two");
         Int_Cache.Put (Cache, 3, "three");
         
         Result := Int_Cache.Get (Cache, 1, Value);
         Assert_True (Result, "3.1.1", "Integer key 1 retrievable");
         Assert_Equal (Value, "one", "3.1.2", "Value for key 1 correct");
         
         Result := Int_Cache.Get (Cache, 2, Value);
         Assert_True (Result, "3.1.3", "Integer key 2 retrievable");
         Assert_Equal (Value, "two", "3.1.4", "Value for key 2 correct");
      end;
   ...
   begin
      ...
      declare
         ...
         Result : Boolean;
      begin
         String_Cache.Put_Locked (Cache, "locked_key", 42);
         Result := String_Cache.Is_Locked (Cache, "locked_key");
         Assert_True (Result, "4.1.1", "Put_Locked creates locked entry");
         
         Result := String_Cache.Get (Cache, "locked_key", Value);
      ...
      begin
         String_Cache.Put (Cache, "key1", 100);
         Result := String_Cache.Is_Locked (Cache, "key1");
         Assert_False (Result, "4.2.1", "Regular Put creates unlocked entry");
         
         Result := String_Cache.Get_Locked (Cache, "key1", Value);
      ...
      declare
         ...
         Result : Boolean;
      begin
         String_Cache.Put_Locked (Cache, "key1", 100);
         Result := String_Cache.Is_Locked (Cache, "key1");
         Assert_True (Result, "4.3.1", "Entry is locked after Put_Locked");
         
         String_Cache.Unlock (Cache, "key1");
         Result := String_Cache.Is_Locked (Cache, "key1");
      ...
      declare
         Cache : String_Cache.Cache (Capacity => 10);
      begin
         String_Cache.Unlock (Cache, "nonexistent");
      ...
      declare
         ...
         Result : Boolean;
      begin
         String_Cache.Put_Locked (Cache, "locked1", 1);
         String_Cache.Put (Cache, "unlocked1", 2);
         String_Cache.Put (Cache, "unlocked2", 3);
         
         -- Cache is full, try to add another - should evict unlocked entries first
         String_Cache.Put (Cache, "unlocked3", 4);
         
         Result := String_Cache.Get (Cache, "locked1", Value);
         Assert_True (Result, "5.1.1", "Locked entry not evicted when cache full");
         Assert_Equal (Value, 1, "5.1.2", "Locked entry value preserved");
         
         Result := String_Cache.Is_Locked (Cache, "locked1");
      ...
      begin
         String_Cache.Put_Locked (Cache, "locked1", 1);
         String_Cache.Put_Locked (Cache, "locked2", 2);
         
         -- Cache is full with locked pages, try to add another
         begin
            String_Cache.Put (Cache, "unlocked1", 3);
         exception
      ...
      begin
         ...
         -- Unlock one entry
         String_Cache.Unlock (Cache, "locked1");
         ...
         Result := String_Cache.Get (Cache, "locked2", Value);
         Assert_True (Result, "5.3.2", "Still locked entry preserved");
         
         Result := String_Cache.Get (Cache, "unlocked1", Value);
      ...
      begin
         ...
         String_Cache.Get (Cache, "key1", Value); -- Regular Get
         Result := String_Cache.Is_Locked (Cache, "key1");
      ...
      begin
         ...
         String_Cache.Put (Cache, "key1", 200); -- Regular Put
         Result := String_Cache.Is_Locked (Cache, "key1");
   ...
   begin
      ...
      -- This tests the core ARC algorithm property
      declare
         Cache : String_Cache.Cache (Capacity => 10);
         Value : Integer;
         Result : Boolean;
      begin
         ...
         for I in 1..5 loop
            String_Cache.Put (Cache, "t1_key_" & Integer'Image (I), I);
         end loop;
         
         -- Access some items from T1 (moving them to T2)
         for I in 1..3 loop
            String_Cache.Get (Cache, "t1_key_" & Integer'Image (I), Value);
         end loop;
         ...
         for I in 1..3 loop
            Result := String_Cache.Get (Cache, "t1_key_" & Integer'Image (I), Value);
      ...
      begin
         ...
         for I in 1..5 loop
            String_Cache.Put (Cache, "key_" & Integer'Image (I), I);
         end loop;
         
         -- Access all items to move them to T2
         for I in 1..5 loop
            String_Cache.Get (Cache, "key_" & Integer'Image (I), Value);
         end loop;
         ...
         -- At least the most recently accessed ones
         Result := String_Cache.Get (Cache, "key_5", Value);
      ...
      begin
         -- Sequential writes
         for I in 1..10 loop
            String_Cache.Put (Cache, "seq_" & Integer'Image (I), I);
         end loop;
         
         -- Check that recent items are still in cache
         for I in 6..10 loop
            Result := String_Cache.Get (Cache, "seq_" & Integer'Image (I), Value);
      ...
      begin
         ...
         for I in 1..8 loop
            String_Cache.Put (Cache, "ws_" & Integer'Image (I), I);
         end loop;
         
         -- Repeatedly access a subset (working set)
         for Cycle in 1..5 loop
            for I in 1..4 loop
               String_Cache.Get (Cache, "ws_" & Integer'Image (I), Value);
            end loop;
         end loop;
         
         -- Add new items
         for I in 9..12 loop
            String_Cache.Put (Cache, "new_" & Integer'Image (I), I);
         end loop;
         
         -- Working set items should still be in cache
         for I in 1..4 loop
            Result := String_Cache.Get (Cache, "ws_" & Integer'Image (I), Value);
   ...
   begin
      ...
      declare
         ...
         Result : Boolean;
      begin
         Result := String_Cache.Get (Cache, "any_key", Value);
      ...
      declare
         ...
         Result : Boolean;
      begin
         Result := String_Cache.Is_Locked (Cache, "any_key");
      ...
      declare
         Cache : String_Cache.Cache (Capacity => 10);
      begin
         String_Cache.Unlock (Cache, "any_key");
      ...
      declare
         ...
         Exception_Raised : Boolean := False;
      begin
         String_Cache.Put_Locked (Cache, "locked", 1);
         
         begin
            String_Cache.Put (Cache, "unlocked", 2);
         exception
            when String_Cache.Cache_Full_Of_Locked_Pages =>
               Exception_Raised := True;
         end;
         ...
         Result := String_Cache.Get (Cache, "locked", Value);
      ...
      declare
         ...
         Result : Boolean;
      begin
         String_Cache.Put (Cache, "key", 1);
         String_Cache.Put (Cache, "key", 2);
         String_Cache.Put (Cache, "key", 3);
         
         Result := String_Cache.Get (Cache, "key", Value);
      ...
      begin
         String_Cache.Put (Cache, "key", 1);
         Result := String_Cache.Is_Locked (Cache, "key");
         Assert_False (Result, "12.2.1", "Key not locked after regular Put");
         
         String_Cache.Put_Locked (Cache, "key", 2);
         Result := String_Cache.Is_Locked (Cache, "key");
      ...
      begin
         String_Cache.Put (Cache, "key", 1);
         Result := String_Cache.Get_Locked (Cache, "key", Value);
      ...
      begin
         -- Add 500 items
         for I in 1..500 loop
            String_Cache.Put (Cache, "large_" & Integer'Image (I), I);
         end loop;
         
         -- Check a few items
         Result := String_Cache.Get (Cache, "large_1", Value);
         Assert_True (Result, "13.1.1", "First item in large cache retrievable");
         
         Result := String_Cache.Get (Cache, "large_500", Value);
         Assert_True (Result, "13.1.2", "Last item in large cache retrievable");
         
         Result := String_Cache.Get (Cache, "large_250", Value);
   ...
   begin
      ...
      begin
         ...
         for I in 1..200 loop
            String_Cache.Put (Cache, "stress_" & Integer'Image (I), I);
         end loop;
         
         -- Try to retrieve the last 100 items (should be in cache)
         for I in 101..200 loop
            Result := String_Cache.Get (Cache, "stress_" & Integer'Image (I), Value);
            if Result then
      ...
      begin
         ...
         for I in 1..100 loop
            if I mod 3 = 0 then
               String_Cache.Put (Cache, "mixed_" & Integer'Image (I), I);
            elsif I mod 3 = 1 then
               String_Cache.Put_Locked (Cache, "locked_" & Integer'Image (I), I);
            else
               String_Cache.Get (Cache, "mixed_" & Integer'Image (I-1), Value);
            end if;
         end loop;
         ...
         for I in 1..100 loop
            if I mod 3 = 1 then
               Result := String_Cache.Get (Cache, "locked_" & Integer'Image (I), Value);
               if Result then
                  Success_Count := Success_Count + 1;
               end if;
            end if;
      ...
      begin
         -- Fill cache
         for I in 1..20 loop
            String_Cache.Put (Cache, "cons_" & Integer'Image (I), I);
         end loop;
         
         -- Access all items multiple times
         for Cycle in 1..10 loop
            for I in 1..20 loop
               String_Cache.Get (Cache, "cons_" & Integer'Image (I), Value);
   ...
   begin
      ...
      begin
         -- Fill cache
         String_Cache.Put (Cache, "a", 1);
         String_Cache.Put (Cache, "b", 2);
         String_Cache.Put (Cache, "c", 3);
         
         -- Access 'a' to move it to T2
         String_Cache.Get (Cache, "a", Value);
         
         -- Add 'd', which should evict from T1 (which has 'b' and 'c')
         String_Cache.Put (Cache, "d", 4);
         
         -- Check what was evicted
         Result := String_Cache.Get (Cache, "a", Value);
         Assert_True (Result, "16.1.1", "Recently accessed 'a' still in cache");
         
         Result := String_Cache.Get (Cache, "b", Value);
         Result := String_Cache.Get (Cache, "c", Value);
         -- One of b or c should be evicted, but we don't know which
         -- This proves the assumption that "it always evicts the oldest" is not necessarily true
         Assert (not (Result and String_Cache.Get (Cache, "b", Value)), "16.1.2",
      ...
      begin
         ...
         String_Cache.Get (Cache, "locked", Value);
         
         -- The item should still be locked but might have moved from T1 to T2
         Result := String_Cache.Is_Locked (Cache, "locked");
         ...
         Assert_True (Value = 1, "16.2.2", "Locked item value preserved after Get");
      end;
      ...
      begin
         -- Add many items
         for I in 1..20 loop
            String_Cache.Put (Cache, "cap_" & Integer'Image (I), I);
         end loop;
         
         -- Count how many items are actually in cache
         for I in 1..20 loop
            Result := String_Cache.Get (Cache, "cap_" & Integer'Image (I), Value);
            if Result then
               Count := Count + 1;
            end if;
         end loop;
      ...
      declare
         ...
         Result : Boolean;
      begin
         String_Cache.Put (Cache, "x", 1);
         String_Cache.Put (Cache, "y", 2);
         
         -- Cache has 2 items, capacity is 3, no eviction should happen
         String_Cache.Put (Cache, "z", 3);
         
         Result := String_Cache.Get (Cache, "x", Value);
         Assert_True (Result, "17.2.1", "No eviction when under capacity");
         
         Result := String_Cache.Get (Cache, "y", Value);
         Assert_True (Result, "17.2.2", "No eviction when under capacity");
         
         Result := String_Cache.Get (Cache, "z", Value);
      ...
      declare
         ...
         Result : Boolean;
      begin
         String_Cache.Put (Cache, "unlocked", 1);
         Result := String_Cache.Is_Locked (Cache, "unlocked");
         Assert_False (Result, "18.1.1", "Item is not locked");
         
         String_Cache.Unlock (Cache, "unlocked");
         Result := String_Cache.Is_Locked (Cache, "unlocked");
         Assert_False (Result, "18.1.2", "Item remains unlocked after Unlock");
         
         -- Item should still be in cache
         Result := String_Cache.Get (Cache, "unlocked", Value);
      ...
      declare
         ...
         Result : Boolean;
      begin
         Result := String_Cache.Get_Locked (Cache, "nonexistent", Value);
